...
<body>
  ...
  <div class="header ">
		<div class="container">
			<div class="head"><div class=" logo"><a href="index.action"><img src="img/logo.jpg" alt=""></a></div></div>
		</div>
...
<div  style="float: left;width:980px;height:700px; margin-top: 20px; display: inline-block;white-space: nowrap;">
			...
			<div style="float:left;height:auto;">
				...
				<ul style="list-style: none;display: inline-block;">
					<li><a href="commodity.jsp"><img alt="" src="img/11.webp.jpg" style="width: 200px; height: 200px;margin-left: 30px;"></a></li>
